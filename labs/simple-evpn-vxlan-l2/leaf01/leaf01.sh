...
iface vxlan110 inet manual
    pre-up ip link add name vxlan110 type vxlan id 110 local 172.30.1.3 dstport 4789 nolearning
...
iface br10 inet manual
    ...
    post-up ip link set dev vxlan110 master br10 addrgenmode none
